...
it.each([
  ...
  { start: 50, move: 'L68', expected: 1 },
  { start: 82, move: 'L30', expected: 0 },
  { start: 52, move: 'R48', expected: 1 },
  { start: 0, move: 'L5', expected: 0 },
  { start: 95, move: 'R60', expected: 1 },
  { start: 55, move: 'L55', expected: 1 },
  { start: 0, move: 'L1', expected: 0 },
  { start: 99, move: 'L99', expected: 1 },
  { start: 0, move: 'R14', expected: 0 },
  { start: 14, move: 'L82', expected: 1 },
])(
